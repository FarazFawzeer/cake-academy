<div class="app-sidebar">
    ...
    <div class="logo-box">
        <a href="{{ route('any', 'index') }}" class="logo-dark">
            ...
            <img src="/images/logo-dark.png" class="logo-lg" alt="logo dark" style="width: 150px; height: 75px;">
        </a>

        <a href="{{ route('any', 'index') }}" class="logo-light">
            <img src="/images/logo-dark.png" class="logo-sm" alt="logo sm">
            <img src="/images/logo-dark.png" class="logo-lg" alt="logo light" style="width: 150px; height: 75px;">
        </a>
    </div>
